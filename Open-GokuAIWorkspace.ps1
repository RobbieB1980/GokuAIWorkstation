...
$form.MinimumSize = New-Object System.Drawing.Size(736, 569)
...
$subtitle.Text = 'Open a workspace with GrokBuild issue orchestration'
...
$modeGroup.Size = New-Object System.Drawing.Size(676, 228)
...
$existingRadio.Location = New-Object System.Drawing.Point(20, 29)
...
$existingPath.Location = New-Object System.Drawing.Point(39, 59)
...
$browseExisting.Location = New-Object System.Drawing.Point(564, 58)
...
$newRadio.Text = 'Create a new workspace'
$newRadio.Location = New-Object System.Drawing.Point(20, 106)
...
$nameLabel.Text = 'Name'
$nameLabel.Location = New-Object System.Drawing.Point(40, 181)
$nameLabel.AutoSize = $true
$modeGroup.Controls.Add($nameLabel)

$workspaceName = New-Object System.Windows.Forms.TextBox
$workspaceName.Location = New-Object System.Drawing.Point(111, 177)
...
$optionsGroup.Location = New-Object System.Drawing.Point(22, 350)
...
$status.Text = 'GrokBuild will select repair, migration, or review only when an issue requires it.'
$status.ForeColor = [System.Drawing.Color]::FromArgb(78, 89, 108)
$status.Location = New-Object System.Drawing.Point(24, 454)
$status.Size = New-Object System.Drawing.Size(490, 45)
$status.Anchor = 'Left,Right,Bottom'
$form.Controls.Add($status)

$openFolder = New-Object System.Windows.Forms.Button
$openFolder.Text = 'GokuAI folder'
$openFolder.Location = New-Object System.Drawing.Point(474, 474)
...
$launch.Location = New-Object System.Drawing.Point(588, 474)
...
foreach ($entry in Read-WorkspaceHistory) {
    [void]$existingPath.Items.Add([string]$entry.path)
}
...
function Update-Mode {
    ...
    $parentPath.Enabled = -not $isExisting
    $browseParent.Enabled = -not $isExisting
    $workspaceName.Enabled = -not $isExisting
}
...
$launch.Add_Click({
    try {
        ...
        $status.Text = 'Preparing the workspace and opening GrokBuild...'
